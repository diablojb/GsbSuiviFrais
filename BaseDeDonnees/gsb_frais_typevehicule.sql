...
CREATE TABLE `typevehicule` (
  ...
  `libelleType` char(30) DEFAULT NULL,
  `indemniteKm` decimal(5,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `typevehicule` (`id`, `libelleType`, `indemniteKm`) VALUES ('4cvd','4 chevaux diesel',0.52),('4cve','4 chevaux essence',0.62),('56cvd','5/6 chevaux diesel',0.58),('56cve','5/6 chevaux essence',0.67);
