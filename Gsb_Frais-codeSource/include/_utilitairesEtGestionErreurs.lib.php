 ...
 * @param string $date date d'engagement de la ligne de frais HF
 * @param string $libelle libellé de la ligne de frais HF
 * @param string $montant montant de la ligne de frais HF
