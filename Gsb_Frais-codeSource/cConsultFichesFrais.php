 ...
 * @author jeanbaptiste
 */
//inclut les fichiers du début du document
$repInclude = './include/';
...
<?php
// on propose tous les mois pour lesquels le utilisateur a une fiche de frais
$req = obtenirReqMoisFicheFrais(obtenirIdUserConnecte(),null);
...
if ($etape == "validerConsult") {
    if (nbErreurs($tabErreurs) > 0) {
        ...
        // forfaitisés du utilisateur connecté pour le mois demandé
        $req = obtenirReqEltsForfaitFicheFrais($moisSaisi, obtenirIdUserConnecte());
        $idJeuEltsFraisForfait = mysql_query($req, $idConnexion);
        echo mysql_error($idConnexion);
        $lgEltForfait = mysql_fetch_assoc($idJeuEltsFraisForfait);
        // parcours des frais forfaitisés du utilisateur connecté
        ...
        ?>
                <table class="listeLegere">
                    ...
                    <tr>
                <?php
                // premier parcours du tableau des frais forfaitisés du utilisateur connecté
    ...
    <?php
    //inclut les fichiers pour la fin de la page
